        ...
        <div class="container">
            ...
            <div class="mt-10 sm:mt-0">
                <div class="bg-yellow-500 py-4 px-4">
                    <h3 class="text-lg font-medium leading-6 text-white text-center text-yellow-200">Create New Classes</h3>
                </div>
                    ...
                    <div class="md:col-span-1 px-4 shadow overflow-hidden sm:rounded-md bg-white">
                        <div class="p-5 sm:px-0">
                            <p class="mt-1 text-sm text-gray-600">
                                Hello user,<br><br> Create new classes here and assign a teacher.
                            </p>
                        </div>
                    </div>
