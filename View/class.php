            ...
            <div class="grid gap-6">
                <div class="rounded md:col-span-6 h-full">
                    <table class="w-full table-fixed">
                        <thead>
                        <tr>
                            <th class="bg-yellow-500 text-left w-1/3 px-4 py-3 text-white font-normal">Id</th>
                            <th class="bg-yellow-500 text-left w-1/3 px-4 py-3 text-white font-normal">Name</th>
                            <th class="bg-yellow-500 text-left w-1/3 px-4 py-3 text-right">
                                <form method="get">
                                    <input type="submit" name="class" value="Create New"
                                           class="hover:transition ease-in-out transition-1000 cursor-pointer w-28 inline-flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-yellow-400 hover:bg-yellow-600 shadow-md">
                                </form>
