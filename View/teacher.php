            ...
            <div class="grid gap-6">
                <div class="rounded md:col-span-6 h-full">
                    <table class="w-full table-fixed">
                        <thead>
                        <tr>
                            <th class="bg-purple-600 text-left w-1/3 px-4 py-3 text-white font-normal">Id</th>
                            <th class="bg-purple-600 text-left w-1/3 px-4 py-3 text-white font-normal">Name</th>
                            <th class="bg-purple-600 text-left w-1/3 px-4 py-3 text-right">
                                <form method="get">
